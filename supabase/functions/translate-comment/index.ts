...
serve(async (req) => {
  ...
  try {
    ...
    const instruction = `Translate the following text to ${targetLang}. Only return the translated text, nothing else.`;
    ...
    console.error('Error in translate-comment function:', error);
    return new Response(
