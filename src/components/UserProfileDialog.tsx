            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {profile.prompts_count} {profile.prompts_count === 1 ? "Prompt" : "Prompts"} hochgeladen
                </p>
              </div>
            </div>
                ...
                <div className="flex gap-3">
                  {profile.instagram_url && (
                    <a
                      ...
                      className="flex items-center gap-2 rounded-lg border border-border/40 bg-gradient-card px-4 py-2 transition-all hover:scale-105 hover:shadow-glow"
                    >
