    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-4xl text-center space-y-8">
        ...
        <p className="text-2xl md:text-3xl font-semibold text-foreground">
          Der Ort, an dem Ideen zu Bildern werden.
        </p>
        ...
        <p className="text-base text-muted-foreground max-w-2xl mx-auto">
          Melde dich an, um eigene Prompts zu{" "}
          <span className="text-primary font-medium">speichern</span> und die besten Ideen anderer zu{" "}
          <span className="text-primary font-medium">favorisieren</span>.
        </p>
